...
public class WelcomeActivity extends AppCompatActivity implements SensorEventListener, UploadRequestBody.UploadCallback {

    public static final String DB_NAME = "PersuasiveTSO.db";
    TextView TAGStepGoal, TAGStepValue, dummyTV, DeviceID, DeviceInfo;
    ...
    public class Record {
        ...
        Record(int r,String dev_id, String dev_info,Date d,int a,int b, int c) {
            rowid=r; did=dev_id; dinfo=dev_info; reset_value=a; counter=b; today_steps=c; date=d;
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TAGStepValue = (TextView) findViewById(R.id.WelcomeTV);
      ...
      //  TAGStepGoal.setText(sTAGStepGoal.toString());
        ...
        DeviceID.setText("Android ID: " + String.valueOf(m_androidId));
        DeviceInfo.setText("Device Name: " + String.valueOf(getDeviceName()));
    ...
    public void uploadDatabase(String databaseName) {
        ...
        call.enqueue(new Callback<UploadResponse>() {
            ...
            public void onResponse(Call<UploadResponse> call, Response<UploadResponse> response) {
                Toast.makeText(WelcomeActivity.this, "Database Updated", Toast.LENGTH_LONG).show();
            }
    ...
    WelcomeActivity.Record last=null;
    @Override
    public void onSensorChanged(SensorEvent event) {
        ...
        try {
            ...
            if(last.date.compareTo(current_date) ==0)
            {
                ...
                long row = dbWrite.update("welcome", values, "rowid="+last.rowid,null);
                dbWrite.close();
            }
            ...
            else
            {
              ...
              //  values.put("todays_goal", 7500);
                long row = dbWrite.insert("welcome", null, values);
                dbWrite.close();
            }
    ...
    public WelcomeActivity.Record readLastRow () {
        dbHelper = new GoalsDbHelper(this);
        dbRead = dbHelper.getReadableDatabase();

        String projection[] = {"rowid","did","dinfo","date","reset_value","counter","today_steps"};

        //cursor will hold all of the records
        cursorGoalsDb = dbRead.query("welcome", projection,null,null,null,null,null);

        //I want only last row
        cursorGoalsDb.moveToLast();
        Record rec = null;
        try {
            rec = new WelcomeActivity.Record(Integer.valueOf(cursorGoalsDb.getString(0)),cursorGoalsDb.getString(1),cursorGoalsDb.getString(2),date_formatter.parse(cursorGoalsDb.getString(3)),Integer.valueOf(cursorGoalsDb.getString(4)),Integer.valueOf(cursorGoalsDb.getString(5)),Integer.valueOf(cursorGoalsDb.getString(6)));
        } catch (ParseException e) {
            e.printStackTrace();
        }
